...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { department: @professor.department, first_name: @professor.first_name, last_name: @professor.last_name } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { department: @professor.department, first_name: @professor.first_name, last_name: @professor.last_name } }
